...
public partial class Presentacion_panel_ReporteInventario : System.Web.UI.Page
{
    ...
    protected Reportes ObtenerInforme()
    {
        ...
        personaInformacion = datos.Tables["inventario"];

        CoreUsuario core = new CoreUsuario();
        core.Core_Obtener_Informe_Inventario(fila, personaInformacion);
